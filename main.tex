...
and declared revenue routing through a fixed 25/25/25/25 split between
Artist, Agent, Platform, and Protocol. Revenue splits are stored as
canonical on-chain metadata today. Enforcement via dedicated routing
...
All Genesis agents are currently registered on Base Sepolia testnet.\
...
{\small\itshape Spirit Protocol --- Whitepaper v1.2.1 --- January 2026}\\
